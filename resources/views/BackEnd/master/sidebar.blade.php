<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    <form role="search">
        ...
        <li @yield('comment')><a href="../admin/comment"><svg class="glyph stroked notepad "><use xlink:href="#stroked-notepad" /></svg> Bình Luận</a></li>
        <li role="presentation" class="divider"></li>
        <li @yield('user')><a href="../admin/#"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Quản lý thành viên</a></li>
